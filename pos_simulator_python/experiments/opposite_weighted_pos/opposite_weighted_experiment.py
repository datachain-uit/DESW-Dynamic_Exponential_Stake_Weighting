...
Experiment with the OPPOSITE_WEIGHTED Proof-of-Stake algorithm
"""
...
def run_opposite_weighted_experiment(starting_gini=0.3, n_epochs=50000):
    """Run OPPOSITE_WEIGHTED PoS experiment"""
...
def main():
    ...
    try:
        ...
        print("\n" + "=" * 60)
        print("OPPOSITE_WEIGHTED PoS experiment completed successfully!")
